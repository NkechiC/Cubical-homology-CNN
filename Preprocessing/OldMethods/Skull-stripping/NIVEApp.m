classdef NIVEApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            NIVEApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'NIVE')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong NIVE
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'NIVE').getString, ...
